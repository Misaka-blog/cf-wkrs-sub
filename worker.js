...
<body>
  ...
  <p>
    Copy this sub link along with the operator code in your v2ray app. For example, in the first companion, it will be as follows:
  </p>
  <p>
    <a href="https://${url.hostname}/sub/mci">https://${url.hostname}/sub/mci</a>
  </p>
  <p>
    Or add this link along with clean IP in your app:
  </p>
  <p>
    <a href="https://${url.hostname}/sub/1.2.3.4">https://${url.hostname}/sub/1.2.3.4</a>
  </p>
  <p>
    You can separate multiple clean IPs with commas. In this case, for each clean IP in the specified number, it will deliver the config combined with the worker:
  </p>
  <p>
    <a href="https://${url.hostname}/sub/1.2.3.4,9.8.7.6">https://${url.hostname}/sub/1.2.3.4,9.8.7.6</a>
  </p>
  <p>
    With exactly the same model, you can also use a clean IP domain:
  </p>
  <p>
    <a href="https://${url.hostname}/sub/mci.ircf.space">https://${url.hostname}/sub/mci.ircf.space</a>
  </p>
  <p>
    You can also use some clean IE subdomains:
  </p>
  <p>
    <a href="https://${url.hostname}/sub/mci.ircf.space,my.domain.me">https://${url.hostname}/sub/mci.ircf.space,my.domain.me</a>
  </p>
  <p>
    You can specify the number of configurations with the max variable:
  </p>
  <p>
    <a href="https://${url.hostname}/sub?max=200">https://${url.hostname}/sub?max=200</a>
  </p>
  <p>
    You can also use the original variable with the number 0 or 1 or with yes/no to specify whether the original configuration (not combined with the worker) is included in the output or not:
  </p>
  <p>
  ...
  <p>
    If necessary, you can specify with the merge variable that the combined configs are deleted:
  </p>
  <p>
    <a href="https://${url.hostname}/sub?max=200&original=yes&merge=no">https://${url.hostname}/sub?max=200&original=yes&merge=no</a>
  </p>
  <p>
    You can also specify fp and alpn:
  </p>
  <p>
  ...
  <p>
    If needed, you can specify which type of configs to list for you for the main configs:
  </p>
  <p>
    <a href="https://${url.hostname}/sub?max=200&type=vmess,ss,ssr,vless">https://${url.hostname}/sub?max=200&type=vmess,ss,ssr,vless</a>
  </p>
  <p>
    If needed, you can limit the list of providers:
  </p>
  <p>
